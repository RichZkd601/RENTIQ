  ...
  public: {
    Tables: {
      ...
      opportunities: {
        ...
        Relationships: [
          {
            foreignKeyName: "opportunities_investor_profile_id_fkey"
      ...
      properties: {
        ...
        Relationships: [
          {
            foreignKeyName: "properties_source_analysis_id_fkey"
      ...
      regulatory_alert_reads: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "regulatory_alert_reads_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      redeem_invitation: { Args: { p_code: string }; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
